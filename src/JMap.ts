...
export const getInt = (object: number, key: string, defaultVal: number = 0): number => sn.getInt(object,  key,  defaultVal)
...
export const valueType = (object: number, key: string): number => sn.valueType(object,  key)

/** Returns a new array containing all keys */
export const allKeys = (object: number): number => sn.allKeys(object)
export const allKeysPArray = (object: number): string[] => sn.allKeysPArray(object)
...
export const removeKey = (object: number, key: string): boolean => sn.removeKey(object,  key)
...
/** Simplifies iteration over container's contents.
    ...
    Usage:
        ...
        endwhile */
export const nextKey = (object: number, previousKey: string = "", endKey: string = ""): string => sn.nextKey(object,  previousKey,  endKey)

/** Retrieves N-th key. negative index accesses items from the end of container counting backwards.
    Worst complexity is O(n/2) */
export const getNthKey = (object: number, keyIndex: number): string => sn.getNthKey(object,  keyIndex)
